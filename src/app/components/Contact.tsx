      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
            Ready to Protect Your <span className="text-blue-600">Property?</span>
          </h2>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Contact us today for a free quote or to schedule a service. We're here to help!
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
          ...
          <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button
                type="submit"
                className="w-full flex items-center justify-center gap-2 bg-red-600 text-white px-6 py-4 rounded-lg hover:bg-red-700 transition-colors font-medium text-lg"
              >
